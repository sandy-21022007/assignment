...
@app.callback(
    Output(component_id='<year dropdown id>', component_property='disabled'),
    Input(component_id='<statistics dropdown id>', component_property='<selected value property>')
)

def update_input_container(<selected statistics parameter>):
    if selected_statistics == '<yearly statistics option>':
